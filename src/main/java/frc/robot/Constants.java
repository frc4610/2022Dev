...
public final class Constants {
  ...
  //  public static final int DRIVETRAIN_PIGEON_ID = 0; // FIXME Set Pigeon ID
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(149.85); // FIXME Measure and set front left steer offset
//Front left off set value: 149.85
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(181.40); // FIXME Measure and set front right steer offset
//Front right off set value: 181.40
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(128.76); // FIXME Measure and set back left steer offset
//Back left off set value: 128.76
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(30.05); // FIXME Measure and set back right steer offset
//Back right off set value: 30.05
}
